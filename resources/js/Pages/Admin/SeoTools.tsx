    ...
    return (
        <div className="space-y-1">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                ...
                <button
                    type="button"
                    className="shrink-0 rounded-lg border border-amber-500/40 bg-amber-500/10 px-4 py-2 text-sm font-medium text-amber-400 transition hover:bg-amber-500/20"
    ...
    return (
        <AdminLayout>
            ...
            <div className="space-y-8">
                <div>
                    <h1 className="text-2xl font-bold text-white">SEO ve site haritası</h1>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    <section className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-6">
                        <div className="mb-4 flex items-center gap-2 text-amber-400">
                            ...
                            <h2 className="text-lg font-semibold text-white">XML site haritası</h2>
                        </div>
                        ...
                        <div className="mt-4 flex flex-wrap gap-3">
                            <a
                                ...
                                className="inline-flex items-center gap-2 rounded-lg border border-zinc-600 bg-zinc-800 px-4 py-2 text-sm text-zinc-200 transition hover:bg-zinc-700"
                            >
                    ...
                    <section className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-6">
                        ...
                        <p className="mb-4 text-sm text-zinc-400">
                            Arama motorlarına site haritası konumunu bildirir. Ortamınızdaki <code className="text-amber-200/90">APP_URL</code>{' '}
                ...
                <section className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-6">
                    <div className="mb-4 flex items-center gap-2 text-amber-400">
                        ...
                        <h2 className="text-lg font-semibold text-white">Google araçları</h2>
                    </div>
                    <ul className="space-y-3 text-sm text-zinc-300">
                        <li>
                            ...
                            <code className="rounded bg-zinc-800 px-1.5 py-0.5 text-xs text-zinc-200">sitemap.xml</code>
                        </li>
                        <li>
                            <a href={richResultsTestUrl} target="_blank" rel="noopener noreferrer" className="text-amber-400 hover:text-amber-300">
                ...
                <p className="text-sm text-zinc-500">
                    <Link href={route('admin.settings.index')} className="text-amber-400 hover:text-amber-300">
                        Site ayarları
                    </Link>
                    ’na dön
                </p>
